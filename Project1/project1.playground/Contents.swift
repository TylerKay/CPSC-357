...
/*: # Section B, Question 8 - Sum of powers:
 The function would take in two integers, m and n, which takes the summation of and determines what point will the summation stop. The function will return and output the double of the summation of the powers.
